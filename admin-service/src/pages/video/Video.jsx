      ...
      <div className="flex flex-1 w-full justify-center overflow-hidden bg-gray-900">
        <div className="w-[80%] overflow-hidden">
          ...
          <div className="mt-4 mb-4">
            ...
            <div className=" w-full">
              <div className="overflow-auto h-[85vh] w-full">
                ...
                <tr className="bg-gray-800">
                  ...
                  <td className="p-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</td>
                  <td className="p-3 font-bold">
                  <div className="flex align-items-center justify-center">
                      <img
                        className="rounded-md h-28 w-32  object-cover"
            ...
            <td className="p-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.5</td>
            <td className="p-3 font-bold">
            <div className="flex align-items-center justify-center">
                <img
                  className="rounded-md h-28 w-32  object-cover"
