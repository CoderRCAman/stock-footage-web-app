      ...
      <div className="w-full mt-10 bg-neutral-800  flex justify-evenly   flex-col xl:flex-row  xl:px-5    min-h-[200px]">
        <div className="xl:w-[85%]  flex justify-center py-5">
          <img
            ...
            src={state?.src || state.public_url}
          />
        </div>
        <div className="xl:w-[15%]  w-full border-t-[1px] border-slate-700  xl:border-t-0 xl:border-l-[1px]  flex flex-col justify-center xl:justify-start sm:flex-col items-center gap-3 py-5">
